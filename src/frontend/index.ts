...
const drawPreview = (preview: Tetromino): void => {
    const previewElement = queryPreviewElement();
...
const drawTetromino = (currentBlock: Tetromino, currentPosition: Position) => {
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const room: Room<GameState> = await client.joinOrCreate<GameState>("game").then(room => {
